/* =========================================================================
   ...
   SULLE SVEGLIE: un sito web non può far scattare un promemoria a telefono
   chiuso (su iOS le notifiche locali programmate non esistono per il web, su
   Android il sistema spegne il processo). Quindi:
     · dentro l'app: avviso immediato mentre è aperta + elenco degli scaduti
       alla riapertura;
     · fuori dall'app: l'evento viene esportato in formato .ics con le sveglie
       già dentro (VALARM) e affidato al calendario del telefono, che suona
       da solo, anche offline.
   ========================================================================= */
(function () {
  'use strict';
  ...
  function elimina() {
    ...
    save(); chiudiSheet(); programmaTimer(); renderAttuale(); Hub.refreshHome();
  ...
  function importa(file) {
    ...
    r.onload = function () {
      ...
      save(); programmaTimer(); renderAttuale(); Hub.refreshHome();
